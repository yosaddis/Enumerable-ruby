# Enumrable In Ruby<a name="readme-top"></a>
...
**Enumrable In Ruby** This project creates a module to implement functionality of custom enumerables.
...
```bash
git clone https://github.com/yosaddis/Enumerable-ruby.git
```
